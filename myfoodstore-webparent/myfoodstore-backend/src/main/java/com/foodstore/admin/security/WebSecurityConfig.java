...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	@Bean
	public FoodStoreUserService foodStoreUserService() {
		return new FoodStoreUserService();
	}
	...
	public DaoAuthenticationProvider authenticationProvider() {
		...
		daoAuthenticationProvider.setUserDetailsService(foodStoreUserService());
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/users/**").hasAuthority("Admin")
				.antMatchers("/categories/**", "/cuisines/**").hasAnyAuthority("Admin", "Editor")
	...
	public void configure(WebSecurity web) throws Exception {
		web.ignoring().antMatchers("/images/**", "/js/**", "/webjars/**", "/user-photo/**");
	}
}
